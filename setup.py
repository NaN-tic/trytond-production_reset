...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    url='https://github.com/NaN-tic/trytond-production_reset',
    download_url='https://github.com:nantic/trytond-production_reset.git',
    ...
    project_urls = {
       "Source Code": 'https://github.com:NaN-tic/trytond-production_reset.git'
    },
    classifiers=[
